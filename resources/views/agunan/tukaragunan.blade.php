...
<div class="container">
    <div class="row">
        <div class="col-sm-12">
            ...
            <form class="form-horizontal" id="simpankreditform" role="form" method="POST" action="{{ url('/savetukaragun/$nokredit') }}" >
                <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                <div class="panel panel-primary" id="panelkredit">
                <div class="panel-heading"><h4 align="center">MASUKKAN DATA AGUNAN PENGGANTI</h4></div>
                <!-- <div style="border: 20px outset #2a4aeb; height: 80px; text-align: center; width: 1140px; "><h4 align="center"><b>ADDENDUM AGUNAN</b></h4></div> -->
                    <div class="panel-body">
                        <div class="row">
                          <div class="col-sm-12">
                            ...
                            @foreach($prekredit as $pre) 
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-7">                                        
                                        <input type="text" class="form-control" name="no_nsb[]" autocomplete="off" style="text-transform:   uppercase;" value="{{$pre->no_nsb}}" readonly required />
                                    </div>
                                </div> 
                                <div class="row form-group">
                                            <label class="col-sm-5 control-label">Nomor CIF</label>
                                            <div class="col-sm-7">                                        
                                                <input type="text" class="form-control" name="no_cif[]" autocomplete="off" style="text-transform:uppercase;" value="{{$pre->no_cif}}" readonly required />
                                            </div>
                                        </div>
                                <div class="row form-group">
                                    <label class="col-sm-5 control-label">Nomor Kredit</label>
                                        <div class="col-sm-7">                                        
                                        <input type="text" class="form-control" name="no_kredit[]" autocomplete="off" style="text-transform:uppercase;" value="{{$pre->no_kredit}}" readonly required />
                                        </div>
                                </div>
                            @endforeach
                            ...
                            <!-- <div class="row form-group">
                                <label class="col-sm-5 control-label" name = "aden" value = "aden">Tanggal Addendum</label>
                                    <div class="col-sm-7">
                                        <div class="input-group date">
                                            <input type="text" id="inputtgladen" name="input_tgladen" class="form-control" placeholder="dd-mm-YYYY">
                                        <div class="input-group-addon">
                                            <span class="fa fa-calendar"></span>
                                        </div>
                                        </div>
                          ...
                          <input type="button" class="btn btn-primary" value="Tambah Jaminan Kendaraan" id="addAgKend" />
                          <input type="button" class="btn btn-primary" value="Tambah Jaminan Sertifikat" id="addAgSert" />
                          <input type="button" class="btn btn-primary" value="Tambah Jaminan Alat Berat" id="addberat" />
                            ...
                            <div class="panel-heading"><h4 align="center"><b>AGUNAN SERTIFIKAT</b></h4></div>
                                            <div class="col-sm-6">
                                                ...
                                                <label class="col-sm-4 control-label">Status Agunan</label>
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control" name="input_status_s[]" autocomplete="off" value="pengganti " readonly />
                                                    </div>                                    
                                                </div>
                                                <div class="row form-group">
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <select class="form-control" name="input_kode_jns_pengikatan_s[]" required>
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                      <input type="text" class="form-control" name="input_tgl_pengikatan_s[]" placeholder ="{{date('d-m-Y')}}" id="input_tgl_pengikatan" required >
                                                    </div>
                                                </div>
                                                <div class="row form-group">
        ...
        <div class="col-sm-12">
                            ...
                            <div class="panel-heading"><h4 align="center"><b>AGUNAN KENDARAAN</b></h4></div>
                                            <div class="col-sm-6">
                                                ...
                                                <label class="col-sm-4 control-label">Status Agunan</label>
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control" name="input_status_k[]" autocomplete="off" value="pengganti " readonly />
                                                    </div>                                    
                                                </div>
                                                <div class="row form-group">
                                                <label class="col-sm-4 control-label">*Kode Agunan</label>
...
<div id="AlatBerat" data-op ="AlatBerat" hidden>
    ...
    <div class="row">
        <div class="col-sm-12"><br>
            <input type="button" value="Hapus" class="btn btn-warning pull-right" name="hapusberat" />
        </div>
    <br>
        <div class="col-sm-12">
                            <div class="col-sm-3">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#addberat').click(function(){
            ...
            $('[name="hapusberat"]').on('click',function(){
                $(this).closest("div.row").remove();
                    e.preventDefault();
                // $(this).parent().parent().parent().remove();
            });
