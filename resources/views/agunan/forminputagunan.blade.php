...
<div class="container">
    <div class="row">
        <div class="col-sm-12">
            ...
            <form class="form-horizontal" id="simpankreditform" role="form" method="POST" action="{{ url('/saveAgunan/$nonsb/$nokredit') }}" >
                          ...
                          <div class="col-sm-12"> 
                            <div class="col-sm-6"> 
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-8">                                        
                                        <input type="text" class="form-control" name="no_nsb[]" autocomplete="off" style="text-transform:uppercase;" value="{{$nasabah->no_nsb}}" readonly required />
                                    </div>
                                </div> 
                                <div class="row form-group">
                                    <label class="col-sm-4 control-label">Nomor Kredit</label>
                                        <div class="col-sm-8">                                        
                                        <input type="text" class="form-control" name="no_kredit[]" autocomplete="off" style="text-transform:uppercase;" value="{{$prekredit_nuk->no_kredit}}" readonly required />
                                        </div>
                                </div>
                            ...
                            <div class="col-sm-6"> 
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-7">                                        
                                        <input type="text" class="form-control" name="no_cif[]" autocomplete="off" style="text-transform:uppercase;" value="{{$nasabah->no_cif}}" readonly required />
                                    </div>
                                </div> 
                                <div class="row form-group">
                                ...
                                ?>
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="row form-group">
                                                    <label class="col-sm-4 control-label">Kode Jenis Pengikatan</label>
                                                    <div class="col-sm-8">
                                                        <select class="form-control" name="input_kode_jns_pengikatan_k[]" required>
                                                            <option value >-Pilih Kode Jenis Pengikatan-</option>
                                                            @foreach($ikat as $i)
                                                                <option value="{{$i->kode}}">{{$i->kode}} - {{$i->nama}}</option>
                                                            @endforeach
                                                ...
                                                <div class="row form-group">
                                                    <label class="col-sm-4 control-label">Tanggal Pengikatan</label>
                                                    <div class="col-sm-8">
                                                      <input type="text" class="form-control" name="input_tgl_pengikatan_k[]" placeholder ="{{date('d-m-Y')}}" id="input_tgl_pengikatan" required>
                                                    </div>
                                                </div>
                                               <!--  <div class="row form-group">
                                                    <label class="col-sm-4 control-label">Bukti Kepemilikan</label>
