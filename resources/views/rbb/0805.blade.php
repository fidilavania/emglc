                ...
                <div class="panel-body" align="center">
                    <form action="{{ url('/proses') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row" style="overflow: auto;max-height:10000px">
                            <div class="col-sm-12">
                                <label><h4>Rencana Penyaluran Kredit berdasarkan Sektor Ekonomi yang Menjadi Prioritas Dalam Penyaluran Kredit</h4></label>
                                <table class="table1" name="tabelA">
                                    <thead>
                                        <tr>
                                            ...
                                            <th rowspan="2">Kode Sektor Ekonomi</th>
                                            <th class="th1" rowspan="2">Sektor Ekonomi</th>
    ...
    $(document).ready(function() {
        $('[name="submbutton"]').click(function(){
            if($(this).val() == 'Tampilkan'){
                 window.location.href = '{{url("/0805")}}'+'/'+$('[name="periode"]').val();
            }
