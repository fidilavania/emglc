                ...
                <div class="panel-body" align="center">
                    <form action="{{ url('/proses') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row" style="overflow: auto;max-height:10000px">
                            <div class="col-sm-12">
                                <label><h4>RENCANA PENAMBAHAN MODAL</h4></label>
                                <table class="table1" name="tabelA">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="th1" rowspan="2">Keterangan Baris</th>
                                            <th class="th5" rowspan="2">Rincian Nama Pemegang Saham/Rincian Nama Modal Lainnya</th>
    ...
    $(document).ready(function() {
        $('[name="submbutton"]').click(function(){
            if($(this).val() == 'Tampilkan'){
                 window.location.href = '{{url("/0903")}}'+'/'+$('[name="periode"]').val();
            }
