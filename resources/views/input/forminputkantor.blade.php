    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="row form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="input_nama" autocomplete="off" value="" style="text-transform:uppercase;" placeholder="NAMA Kantor" required />
                </div>
            </div>
            <div class="row form-group">
                <label class="col-sm-3 control-label">Kode Kantor</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="input_kode" autocomplete="off" value="" style="text-transform:uppercase;" placeholder="kode kantor" required />
                </div>
            </div>
        </div>
        <div class="col-sm-6">
