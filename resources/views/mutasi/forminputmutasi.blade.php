...
<div class="container">
    <div class="row">
        <div class="col-sm-12">
            ...
            <form class="form-horizontal" id="simpanform" role="form" method="POST" action="{{ url('/savemut/$nonsb') }}" enctype="multipart/form-data" >
                <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                <div class="panel panel-primary" id="panelnasabah">
                    <div class="panel-heading"><h4 align="center">DATA MUTASI</h4></div>
                    <div class="row">
                        <div class="col-sm-3">
                            <?php
                                ...
                                <div class="panel-heading" align="center">MASUKKAN DATA</div>
                                    <div class="panel-body">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="row form-group" hidden>
                                                <label class="col-sm-3 control-label">Induk Kantor Baru</label>
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control" name="induk_kantor_baru" value="" placeholder="indukkantor" style="text-transform:uppercase" readonly />
                                                    </div>
                                            </div>
                                            <div class="row form-group">
                                                <label class="col-sm-3 control-label">Nama Kantor Baru</label>
                                                <div class="col-sm-8">
                                                    <select class="form-control" name="kantor_baru" required>
                                                        <option value>-Pilih (Kode Induk - Nama Kantor)-</option>
                                                            @foreach($mkantor as $kan)  
                                                                <option value="{{$kan->kode_induk}}-{{$kan->kode_kantor}}">{{$kan->kode_induk}} - {{$kan->nama}}</option>
                                                            @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                ...
                                                <div class="col-sm-9">
                                                     <textarea rows="10" cols="120" name="alasan" value="" placeholder="alasan" style="margin: 0px; width: 734px; height: 110px;" id="alasan"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('[name="kantor_baru"]').select2({ width: '100%' });
