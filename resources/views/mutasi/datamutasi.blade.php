    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="panel panel-primary" id="panelbank">
                <div class="panel-heading"><h4 align="center">DAFTAR MUTASI</h4></div>
                                    ...
                                    <div class="form-inline padding-bottom-15">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 text-center">     
                                                ...
                                                <a href="{{ url('/datamutasi') }}" id="clear-filter" title="clear filter">[KEMBALI]</a>
                                            </div>
                                        </div>
                                        <br>
                                    </div>
            ...
            //Search saat tekan Enter
              if(e.keyCode==13){
                if($("#nama").val() != ""){
                    ...
                    window.location = '{{url("/datamutasi")}}'+'/'+searchword;
                } else {
                    return false;
                }
              }
