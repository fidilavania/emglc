...
<div class="container">
    <div class="row">
        <div class="col-sm-12">
            ...
            <form class="form-horizontal" id="simpanform" role="form" method="POST" action="{{ url('/saveupload/$nourut') }}" >
                <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                <div class="panel panel-primary" id="panelnasabah">
                    <div class="panel-heading"><h4 align="center">UPLOAD FOTO</h4></div>
                    <div class="row">
                        <div class="col-sm-3">
                            <?php
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea name="kegiatan" style="margin: 0px; width: 918px; height: 65px;" id="foto"></textarea>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <label class="col-sm-3 control-label">Link Foto</label>
                                    <div class="col-sm-8">
                                        <textarea name="foto" style="margin: 0px; width: 918px; height: 65px;" id="foto"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
