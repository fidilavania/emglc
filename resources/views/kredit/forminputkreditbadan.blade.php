...
<div class="container">
    <div class="row">
        <div class="col-sm-12">
            ...
            <form class="form-horizontal" id="simpankreditform" role="form" method="POST" action="{{ url('/savekreditbadan/$nonsb') }}" >
  ...
  <!--Panel Tabel Pembayaran -->
                            ...
                            <div class="row submitbtn1">
                                <div class="col-sm-12">
                                    <button type="submit" id="simpandata" class="btn btn-primary" name="simpanbutton" onclick="return confirm('Apakah anda yakin akan menyimpan data ini?')">KE LAPORAN KEUANGAN</button>
                                </div>
                            </div>
                        </div>
