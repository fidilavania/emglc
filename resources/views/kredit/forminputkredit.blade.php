...
<div class="container">
    <div class="row">
        <div class="col-sm-12">
            ...
            <form class="form-horizontal" id="simpankreditform" role="form" method="POST" action="{{ url('/saveKredit/$nonsb') }}" >
                <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                <div class="panel panel-primary" id="panelnasabah">
                    <div class="panel-heading"><h4 align="center">MASUKKAN DATA KREDIT</h4></div>
                            <div class="panel-body">
                            <div class="col-sm-3">
                                <?php
  ...
  <!--Panel Tabel Pembayaran -->
                        ...
                        <!-- <div ng-if="pinj_pokok >= 5000000000"> -->
                            <div class="panel panel-danger" >
                                <div class="panel-heading"><h5>* Total Pokok Nasabah Lebih Dari 5.000.000.000,-*</h5></div>
                            </div>
                            <div class="panel panel-primary" >
                                <div class="panel-heading"><h4 align="center">MASUKKAN DATA LAPORAN KEUANGAN</h4></div>
                                <div class="row">
                                    <div class="col-sm-12">  
                                        <div class="col-sm-4">
                                            <br>
                                                <div class="row form-group">
                                                   <label class="col-sm-5 control-label">Nomor Nasabah</label>
                                                    <div class="col-sm-7">                                        
                                                        <input type="text" class="form-control" name="no_nsb" autocomplete="off" style="text-transform:uppercase;" value="{{trim($nasabah->no_nsb,' ')}}" readonly />
                                                    </div>
                                                </div>
                                                <br>
                                                 <div class="row form-group">
                                                    <label class="col-sm-5 control-label">*Kas dan Setara Kas (Aset Lancar)</label>
                                                    <div class="col-sm-7">
                                                        <div class="input-group">
                                                            <span class="input-group-addon">Rp.</span>
                                                            <input type="text" class="form-control" name="input_kas" autocomplete="off" value=""  id="kas" required />
                                                        </div>
                                                    </div>
                                                </div> 
                                                 <div class="row form-group">
                                                    <label class="col-sm-5 control-label">*Piutang Usaha (Aset Lancar)</label>
                                                    <div class="col-sm-7">
                                                        <div class="input-group">
                                                            <span class="input-group-addon">Rp.</span>
                                                            <input type="text" class="form-control" name="input_piutang_usaha_al" autocomplete="off" value=""  id="piutanglancar" required />
                                                        </div>
                                                    </div>
                                                </div> 
                                                 <div class="row form-group">
                                                    <label class="col-sm-5 control-label">*Investasi (Aset Lancar)</label>
                                                    <div class="col-sm-7">
                                                        <div class="input-group">
                                                            <span class="input-group-addon">Rp.</span>
                                                            <input type="text" class="form-control" name="input_investasi_lacar" autocomplete="off" value=""  id="inveslancar" required />
                                                        </div>
                                                    </div>
                                                </div> 
                                                 <div class="row form-group">
                                                    <label class="col-sm-5 control-label">*Aset Lancar Lain</label>
                                                    <div class="col-sm-7">
                                                        <div class="input-group">
                                                            <span class="input-group-addon">Rp.</span>
                                                            <input type="text" class="form-control" name="input_aset_lancar_lain" autocomplete="off" value=""  id="asetlainlancar" required />
                                                        </div>
                                                    </div>
                                                </div> 
                                                <div class="row form-group">
                                                    <label class="col-sm-5 control-label">*Aset Lancar</label>
                                                    <div class="col-sm-7">
                                                        <div class="input-group">
                                                            <span class="input-group-addon">Rp.</span>
                                                            <input type="text" class="form-control" name="input_aset_lancar" autocomplete="off" value=""  id="asetlancar" required readonly />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    <label class="col-sm-5 control-label">*Piutang Usaha (Aset Tidak Lancar)</label>
                                                    <div class="col-sm-7">
                                                        <div class="input-group">
                                                            <span class="input-group-addon">Rp.</span>
                                                            <input type="text" class="form-control" name="input_piutang_usaha_atl" autocomplete="off" value=""  id="piutangtidak" required />
                                                        </div>
                                                    </div>
                                                </div> 
                                                 <div class="row form-group">
                                                    <label class="col-sm-5 control-label">*Investasi (Aset Tidak Lancar)</label>
                                                    <div class="col-sm-7">
                                                        <div class="input-group">
                                                            <span class="input-group-addon">Rp.</span>
                                                            <input type="text" class="form-control" name="input_invest_tdk_lancar" autocomplete="off" value=""  id="investidak" required />
                                                        </div>
                                                    </div>
                                                </div> 
                                                 <div class="row form-group">
                                                    <label class="col-sm-5 control-label">*Aset Tidak Lancar Lain</label>
                                                    <div class="col-sm-7">
                                                        <div class="input-group">
                                                            <span class="input-group-addon">Rp.</span>
                                                            <input type="text" class="form-control" name="input_aset_tdk_lancar_lain" autocomplete="off" value=""  id="asetlaintidak" required />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    <label class="col-sm-5 control-label">*Aset Tidak Lancar</label>
                                                    <div class="col-sm-7">
                                                        <div class="input-group">
                                                            <span class="input-group-addon">Rp.</span>
                                                            <input type="text" class="form-control" name="input_aset_tdk_lancar" autocomplete="off" value=""  id="asettdklancar" required readonly />
                                                        </div>
                                                    </div>
                                                </div> 
                                                <div class="row form-group">
                                                    <label class="col-sm-5 control-label">*Aset</label>
                                                    <div class="col-sm-7">
                                                        <div class="input-group">
                                                            <span class="input-group-addon">Rp.</span>
                                                            <input type="text" class="form-control" name="input_aset" autocomplete="off" value=""  id="aset" required readonly />
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <br>
                                                <div class="row form-group">
                                                   <label class="col-sm-5 control-label">Nomor CIF</label>
                                                    <div class="col-sm-7">                                        
                                                        <input type="text" class="form-control" name="no_cif" autocomplete="off" style="text-transform:uppercase;" value="{{trim($nasabah->no_cif,' ')}}" readonly />
                                                    </div>
                                                </div>
                                                
                                                <div class="row form-group">
                                                    <label class="col-sm-5 control-label">*Utang Usaha Jangka Pendek</label>
                                                    <div class="col-sm-7">
                                                        <div class="input-group">
                                                            <span class="input-group-addon">Rp.</span>
                                                            <input type="text" class="form-control" name="input_utang_usaha_pndk" autocomplete="off" value=""  id="utangpendek" required />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    <label class="col-sm-5 control-label">*Pinjaman Jangka Pendek</label>
                                                    <div class="col-sm-7">
                                                        <div class="input-group">
                                                            <span class="input-group-addon">Rp.</span>
                                                            <input type="text" class="form-control" name="input_pinjaman_pndk" autocomplete="off" value=""  id="pinjampendek" required />
                                                        </div>
                                                    </div>
                                                </div>   
                                                <div class="row form-group">
                                                    <label class="col-sm-5 control-label">*Liabilitas Jangka Pendek Lain</label>
                                                    <div class="col-sm-7">
                                                        <div class="input-group">
                                                            <span class="input-group-addon">Rp.</span>
                                                            <input type="text" class="form-control" name="input_lia_pndk_lain" autocomplete="off" value=""  id="lialainpendek" required />
                                                        </div>
                                                    </div>
                                                </div> 
                                                <div class="row form-group">
                                                    <label class="col-sm-5 control-label">*Liabilitas Jangka Pendek</label>
                                                    <div class="col-sm-7">
                                                        <div class="input-group">
                                                            <span class="input-group-addon">Rp.</span>
                                                            <input type="text" class="form-control" name="input_lia_pndk" autocomplete="off" value=""  id="liapendek" required readonly />
                                                        </div>
                                                    </div>
                                                </div>
                                                 <div class="row form-group">
                                                    <label class="col-sm-5 control-label">*Pinjaman Jangka Panjang</label>
                                                    <div class="col-sm-7">
                                                        <div class="input-group">
                                                            <span class="input-group-addon">Rp.</span>
                                                            <input type="text" class="form-control" name="input_pinjaman_pnjng" autocomplete="off" value=""  id="pinjampanjang" required />
                                                        </div>
                                                    </div>
                                                </div> 
                                                 <div class="row form-group">
                                                    <label class="col-sm-5 control-label">*Utang Usaha Jangka Panjang</label>
                                                    <div class="col-sm-7">
                                                        <div class="input-group">
                                                            <span class="input-group-addon">Rp.</span>
                                                            <input type="text" class="form-control" name="input_utang_usaha_panjang" autocomplete="off" value=""  id="utangpanjang" required />
                                                        </div>
                                                    </div>
                                                </div> 
                                                 <div class="row form-group">
                                                    <label class="col-sm-5 control-label">*Liabilitas Jangka Panjang Lain</label>
                                                    <div class="col-sm-7">
                                                        <div class="input-group">
                                                            <span class="input-group-addon">Rp.</span>
                                                            <input type="text" class="form-control" name="input_lia_panjang_lain" autocomplete="off" value=""  id="lialainpanjang" required />
                                                        </div>
                                                    </div>
                                                </div> 
                                                 <div class="row form-group">
                                                    <label class="col-sm-5 control-label">*Liabilitas Jangka Panjang</label>
                                                    <div class="col-sm-7">
                                                        <div class="input-group">
                                                            <span class="input-group-addon">Rp.</span>
                                                            <input type="text" class="form-control" name="input_lia_pnjng" autocomplete="off" value=""  id="liapanjang" required readonly />
                                                        </div>
                                                    </div>
                                                </div>
                                                 <div class="row form-group">
                                                    <label class="col-sm-5 control-label">*Liabilitas</label>
                                                    <div class="col-sm-7">
                                                        <div class="input-group">
                                                            <span class="input-group-addon">Rp.</span>
                                                            <input type="text" class="form-control" name="input_lia" autocomplete="off" value=""  id="lia" required  readonly />
                                                        </div>
                                                    </div>
                                                </div> 
                                        </div>
                                        <div class="col-sm-4">
                                            <br>
                                                <div class="row form-group">
                                                    <label class="col-sm-5 control-label" name = "pakai" value = "pakai">Tanggal Pakai</label>
                                                        <div class="col-sm-7">
                                                ...
                                                <div class="row form-group">
                                                    <label class="col-sm-5 control-label">*Posisi Laporan Keuangan Tahunan</label>
                                                    <div class="col-sm-7">
                                                      <input type="text" class="form-control" name="input_posisi_lapKeuangan_tahunan" id="tahunan" value="{{date('d-m-Y')}}" required/>
                                                    </div>
                                                </div> 
                                                <div class="row form-group">
                                                    <label class="col-sm-5 control-label">*Pendapatan Usaha</label>
                                                    <div class="col-sm-7">
                                                        <div class="input-group">
                                                            <span class="input-group-addon">Rp.</span>
                                                            <input type="text" class="form-control" name="input_pendapatan_usaha" autocomplete="off" value=""  id="pendapatan" required />
                                                        </div>
                                                    </div>
                                                </div> 
                                                 <div class="row form-group">
                                                    <label class="col-sm-5 control-label">*Beban Pokok Pendapatan</label>
                                                    <div class="col-sm-7">
                                                        <div class="input-group">
                                                            <span class="input-group-addon">Rp.</span>
                                                            <input type="text" class="form-control" name="input_beban_pokok" autocomplete="off" value=""  id="beban" required />
                                                        </div>
                                                    </div>
                                                </div>   
                                                <div class="row form-group">
                                                    <label class="col-sm-5 control-label">*Laba/Rugi Bruto</label>
                                                    <div class="col-sm-7">
                                                        <div class="input-group">
                                                            <span class="input-group-addon">Rp.</span>
                                                            <input type="text" class="form-control" name="input_labarugi" autocomplete="off" value=""  id="bruto" required readonly />
                                                        </div>
                                                    </div>
                                                </div> 
                                                <div class="row form-group">
                                                    <label class="col-sm-5 control-label">*Ekuitas</label>
                                                    <div class="col-sm-7">
                                                        <div class="input-group">
                                                            <span class="input-group-addon">Rp.</span>
                                                            <input type="text" class="form-control" name="input_ekuitas" autocomplete="off" value=""  id="ekui" required readonly />
                                                        </div>
                                                    </div>
                                                </div> 
                                                <div class="row form-group">
                                                    <label class="col-sm-5 control-label">*Pendapatan Lain-Lain</label>
                                                    <div class="col-sm-7">
                                                        <div class="input-group">
                                                            <span class="input-group-addon">Rp.</span>
                                                            <input type="text" class="form-control" name="input_pendapatan_lain" autocomplete="off" value=""  id="pendapatanlain" required />
                                                        </div>
                                                    </div>
                                                </div> 
                                                 <div class="row form-group">
                                                    <label class="col-sm-5 control-label">*Beban Lain-Lain</label>
                                                    <div class="col-sm-7">
                                                        <div class="input-group">
                                                            <span class="input-group-addon">Rp.</span>
                                                            <input type="text" class="form-control" name="input_beban_lain" autocomplete="off" value=""  id="bebanlain" required />
                                                        </div>
                                                    </div>
                                                </div> 
                                                <div class="row form-group">
                                                    <label class="col-sm-5 control-label">*Laba/Rugi Sebelum Pajak</label>
                                                    <div class="col-sm-7">
                                                        <div class="input-group">
                                                            <span class="input-group-addon">Rp.</span>
                                                            <input type="text" class="form-control" name="input_labarugi_sblmPajak" autocomplete="off" value=""  id="pajak" required readonly />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    <label class="col-sm-5 control-label">*Laba/Rugi Tahun Berjalan</label>
                                                    <div class="col-sm-7">
                                                        <div class="input-group">
                                                            <span class="input-group-addon">Rp.</span>
                                                            <input type="text" class="form-control" name="input_labarugi_tahun" autocomplete="off" value=""  id="tahun" required />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group pull-right">
                                                    <div class="row">
                                                         <div class="col-sm-4">
                                                            <button type="button" id="generateTable" class="btn btn-warning" onclick="jumlah()">JUMLAHKAN</button>
                                                        </div>
                                                      </div>
                                                </div>  
                                        </div>
                        ...
                        @endif
                            ...
                            <div class="row submitbtn1">
                                <div class="col-sm-12">
                                    <button type="submit" id="simpandata" class="btn btn-primary" name="simpanbutton" onclick="return confirm('Apakah anda yakin akan menyimpan data ini?')">KE AGUNAN</button>
                                </div>
                            </div>
                        </div>
