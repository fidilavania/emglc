                        ...
                        <table width=100%>
                         <tr>
                            <th colspan="12" style="background-color: #ededed" width=100% onclick="window.print()" >
                                <font size="7">KARTU ANGSURAN</font>
                            </th>
                            <tr>
                            ...
                            <tr>
                             ...
                             <tr>
                                <td>Alamat</td><td colspan=2>: {{$datanasabah->alamat}} {{$datanasabah->rtrw}} {{$datanasabah->desa}} {{$datanasabah->camat}} <br>
                                 ...
                                 <table class="table-bordered"  style="border-style: solid 1px #000000;" name="histpaymenttable" width=100% >
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            //     echo '<td class="angsuran'.$angs->bayar_ke.'angsuranjadwal">'.number_format($angs->angs_pokok,0,'','.').'</td>';
                                            //     echo '<td class="angsuran'.$angs->bayar_ke.'angsuranjadwal">'.number_format($angs->angs_bunga,0,'','.').'</td>';
                                            //     echo '<td class="angsuran'.$angs->bayar_ke.'angsuranjadwal">'.number_format($spiutang,0,'','.').'</td>';
                                            //     echo '<td class="angsuran'.$angs->bayar_ke.'angsuranjadwal">'.number_format($datanasabah->plafon-($angs->pokok),0,'','.').'</td>';
                                            //      echo '<td class="angsuran'.$angs->bayar_ke.'angsuranjadwal">'.number_format($datanasabah->bbt-$angs->angs_bunga,0,'','.').'</td>';
                                            //     echo '</tr>';
                                         ...
                                         foreach($jadwal as $j){
                                            ...
                                            echo '<td>'.number_format($j->angsur,0,'','.').'</td>';
                                            echo '<td>'.number_format($j->angs_pokok,0,'','.').'</td>';
                                            echo '<td>'.number_format($j->angs_bunga,0,'','.').'</td>';
                                            echo '<td>'.number_format($j->sal_pokok,0,'','.').'</td>';
                                            echo '<td>'.number_format($j->sal_bbt,0,'','.').'</td>';
                                            echo '<td>'.number_format($j->sal_piutang,0,'','.').'</td>';
                                            echo '</tr>';
                                        }
                                        ?>
