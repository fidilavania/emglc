...
<div class="container">
    <div class="row">
        <div class="col-sm-12">
            ...
            <form class="form-horizontal" id="simpankreditform" role="form" method="POST" action="{{ url('/saveKreditAden/$nokredit') }}" >
                <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                <div class="panel panel-primary" id="panelnasabah">
                    <div class="panel-heading"><h4 align="center">ADENDUM KREDIT</h4></div>
                     <!-- <div style="border: 20px outset #2a4aeb; height: 80px; text-align: center; width: 1140px;"><h4 align="center"><b>ADDENDUM KREDIT</b></h4></div> -->
                            <div class="panel-body">
                            <h4 align="center">-DATA KREDIT NASABAH-</h4>
                            <hr style="height:2px;border:none;color:#444;background-color:#151B8D;"/>
                                                   ...
                                                   <div class="col-sm-4">
                                                    ...
                                                    @endforeach
                                                        ...
                                                        <div class="row form-group">
                                                            ...
                                                            <div class="col-sm-6">{{$daf->sifatkrd}}</div>                                   
                                                        </div>
                                                        <div class="row form-group">
                                                    ...
                                                    <div class="col-sm-4">
                                                     @foreach($lihat1 as $ll)
                                                        <div class="row form-group">
                                                            <div class="col-sm-6 "><b>Nama AO:</b></div>
                                                            <div class="col-sm-6">
                                                                {{$ll->aoku}}                                   
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                        ...
                                                        <div class="row form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                              {{date('d-m-Y',strtotime($daf->tgl_macet))}}
                                                            </div>
                                                        </div>
                                                        <div class="row form-group">
                                                        ...
                                                        <div class="row form-group">
                                                            <div class="col-sm-6 "><b>Tanggal Nunggak:</b></div>
                                                            <div class="col-sm-6">
                                                            {{date('d-m-Y',strtotime($daf->tgl_nunggak))}}
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        ...
                                                        <div class="row form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                              {{date('d-m-Y',strtotime($daf->tgl_resawal))}}
                                                            </div>
                                                        </div>
                                                        <div class="row form-group">
                                                            <div class="col-sm-6 "><b>Tanggal Restrukturisasi Akhir :</b></div>
                                                            <div class="col-sm-6">
                                                              {{date('d-m-Y',strtotime($daf->tgl_resakhir))}}
                                                            </div>
                                                        </div>
                                                        <div class="row form-group">
                                                        ...
                                                        <div class="row form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                              {{date('d-m-Y',strtotime($daf->tgl_kondisi))}}
                                                            </div>
                                                        </div>                              
                                                        <div class="row form-group">
                                    ...
                                    <div class="row">
                                        <h4 align="center">PEMBAYARAN</h4><br>
                                        <div class="col-sm-12">
                                            <div class="col-sm-3">
                                                <div class="row form-group">
                                                    <div class="col-sm-6 "><b>Jenis Kredit</b></div>
                                                    <div class="col-sm-6">{{$daf->arav}}
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    <div class="col-sm-6 "><b>Produk Kredit</b></div>
                                                    <div class="col-sm-6">{{$daf->sistem}}
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    <div class="col-sm-6"><b>Pembayaran Pokok Tiap</b></div> 
                                                    <div class="col-sm-6">{{$daf->jangka}} /bulan
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    <div class="col-sm-6 "><b>Jangka Waktu</b></div>
                                                    <div class="col-sm-6">{{$daf->lama}} bulan
                                                    </div>
                                                </div> 
                                                <div class="row form-group">
                                                    <div class="col-sm-6 "><b>Nilai Proyek</b></div>
                                                    <div class="col-sm-6">Rp.{{number_format($daf->nilaiproyek,0,'','.')}}
                                                    </div> 
                                                </div>                                               
                                            </div>
                                            <div class="col-sm-3">
                                                <div class="row form-group">
                                                    <div class="col-sm-6 "><b>Dp</b></div>
                                                        <div class="col-sm-6">Rp.{{number_format($daf->dp,0,'','.')}}              
                                                        </div>
                                                </div>
                                                <div class="row form-group">
                                                    <div class="col-sm-6 "><b>Baki Debet</b></div>
                                                    <div class="col-sm-6">Rp.{{number_format($daf->bakidebet,0,'','.')}}
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    <div class="col-sm-6 "><b>Plafon Awal</b></div>
                                                    <div class="col-sm-6">Rp.{{number_format($daf->plafon,0,'','.')}}
                                                    </div>
                                                </div>  
                                                <div class="row form-group">
                                                    <div class="col-sm-6 "><b>Pinjaman Pokok</b></div>
                                                    <div class="col-sm-6">Rp.{{number_format($daf->pinj_pokok,0,'','.')}}
                                                    </div>
                                                </div>  
                                                <div class="row form-group">
                                                    <div class="col-sm-6 "><b>Suku Bunga</b></div>
                                                     <div class="col-sm-6">{{$daf->pinj_prsbunga}} % / tahun
                                                    </div>
                                                </div>
                                            </div>
                                                <div class="col-sm-3">
                                                    <div class="row form-group">
                                                      <div class="col-sm-6"><b>Angsuran Pokok</b></div>
                                                      <div class="col-sm-6">Rp.{{number_format($daf->angsur_pokok,0,'','.')}}
                                                      </div>
                                                    </div>
                                                    <div class="row form-group">
                                                      <div class="col-sm-6"><b>Angsuran Bunga</b></div>
                                                      <div class="col-sm-6">Rp.{{number_format($daf->angsur_bunga,0,'','.')}}
                                                      </div>
                                                    </div>
                                                    <div class="row form-group">
                                                        <div class="col-sm-6 "><b>BBT</b></div>
                                                            <div class="col-sm-6">Rp.{{number_format($daf->bbt,0,'','.')}}
                                                            </div>
                                                        </div>  
                                                    <div class="row form-group">
                                                        <div class="col-sm-6 "><b>Saldo Piutang</b></div>
                                                            <div class="col-sm-6">Rp.{{number_format($daf->bbt+$daf->pinj_pokok,0,'','.')}}
                                                            </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-3">
                                                    <div class="row form-group">
                                                        <div class="col-sm-6 "><b>Tanggal NPP Kredit</b></div>
                                                            <div class="col-sm-6">{{date('d-m-Y',strtotime($daf->tgl_kredit))}}
                                                            </div>
                                                    </div>
                                                    <div class="row form-group">
                                                        <div class="col-sm-6 "><b>Tanggal Mulai Angsuran</b></div>
                                                            <div class="col-sm-6">{{date('d-m-Y',strtotime($daf->tgl_mulai))}}
                                                            </div>
                                                    </div>
                                                    <div class="row form-group">
                                                        <div class="col-sm-6 "><b>Tanggal Jatuh Tempo Angsuran</b></div>
                                                            <div class="col-sm-6">{{date('d-m-Y',strtotime($daf->tgl_akhir))}}
                                                            </div>
                                                    </div>
                                                </div>
                                        </div>
                                ...
                                <div class="row">
                                <h4 align="center"><br>MASUKKAN DATA KREDIT BARU</h4>
                                <div class="col-sm-3">
                                <?php
                                    ...
                                    <div class="col-sm-12"><br>  
                                        <div class="col-sm-6">
                                                    ...
                                                    <label class="col-sm-3 control-label" name = "aden" value = "aden">*Tanggal Addendum</label>
                                                        <div class="col-sm-9">
                                                            <div class="input-group date">
                                                                <input type="text" id="inputtgladen" name="input_tgladen" class="form-control" placeholder="dd-mm-YYYY" value="{{date('d-m-Y')}}" required/>
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-sm-9">                                        
                                                        <input type="text" class="form-control" name='no_nsb' autocomplete="off" style="text-transform:uppercase;" value="{{$p->no_nsb}}" readonly required />
                                                    </div>
                                                </div> 
                                                 <div class="row form-group" hidden>
                                                    <label class="col-sm-3 control-label">Nomor kredit</label>
                                                    <div class="col-sm-9">                                        
                                                        <input type="text" class="form-control" name='kredit' autocomplete="off" style="text-transform:uppercase;" value="{{$p->no_kredit}}" readonly required />
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    <label class="col-sm-3 control-label">Nomor CIF</label>
                                                    <div class="col-sm-9">                                        
                                                        <input type="text" class="form-control" name='no_cif' autocomplete="off" style="text-transform:uppercase;" value="{{$p->no_cif}}" readonly required />
                                                    </div>
                                                </div> 
                                                ...
                                                <div class="row form-group">
                                                 ...
                                                 <div class="row form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" name='input_frekres' autocomplete="off" value="0" style="text-transform:uppercase;" placeholder="frekuensi restrukturisasi" id="fr" id="pesanfr" required readonly />
                                                    </div>
                                                </div>  
                                                <div class="row form-group">
                            ...
                            <h4 align="center">SIMULASI KREDIT NASABAH</h4><br>
                            <div class="row">
                                <div class="col-sm-12">
                                     <div class="col-sm-4">
                                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="row form-group">
                                          ...
                                          <div class="col-sm-9">
                                            <div class="input-group">
                                              <input type="text" class="form-control rincian" id="inputJangkaWaktu" name="input_jangka_waktu" autocomplete="off" value=''  />
                                              <span class="input-group-addon">bulan</span>
                                            </div>
                                          </div>
                                        </div>
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="inputBunga" name="input_bunga" autocomplete="off" value='' />
                                                    <span class="input-group-addon">% / bulan</span>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <br>
                            <div class="row submitbtn1">
                             ...
                             <!-- <div class="row form-group"> -->
                                @foreach($daftar as $daf)
                                    <div class="col-sm-1">
                                        <div hidden="text" class="col-sm-12" data-id="{{$daf->no_kredit}}">
                                            Nomor Kredit :{{$daf->no_kredit}}
                                        </div>
                                        <div class="col-sm-3">
                                            <input type="button" class="btn btn-warning" name="aden" value="TAMBAH_KREDIT" />
                                        </div>
                                    </div>
                                @endforeach
                            <!-- </div>   -->
