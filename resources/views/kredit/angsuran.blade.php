    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <form class="form-horizontal" id="simpankreditform" role="form" method="POST" action="{{ url('/saveKreditAden/$nokredit') }}" >
                ...
                <div class="panel panel-primary" id="panelnasabah">
                    <div class="panel-heading"><h4 align="center">SIMULASI KREDIT</h4></div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="col-sm-3">
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-sm-6">{{$daf->advance}}
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-sm-6">{{$daf->npokok}} /bulan
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="row form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="input-group">
                                                    <input type="text" class="control-label" name="input_jeniskredit" value='{{$daf->advance}}'/> 
                                        ...
                                        <div class="col-sm-3">
                                          ...
                                          <div class="col-sm-9">
                                            <div class="input-group">
                                              <input type="text" class="form-control" name="input_jangkawaktu_pembayaran" autocomplete="off" value='{{$daf->npokok}}' id="bulan" id="pesanbulan" readonly />
                                        ...
                                        <div class="row form-group">
                                          ...
                                          <div class="col-sm-9">
                                            <div class="input-group">
                                              <input type="text" class="form-control rincian" id="inputJangkaWaktu" name="input_jangka_waktu" autocomplete="off" value='{{$daf->lama}}'  />
                                              <span class="input-group-addon">bulan</span>
                                            </div>
                                          </div>
                                        </div>
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-sm-9">
                                              <div class="input-group">
                                                <span class="input-group-addon">Rp.</span>
                                                <input type="text" class="form-control" id="inputPokokHutang" name="input_pokok_hutang" autocomplete="off" value='{{number_format($daf->pinj_pokok,0,'','.')}}' required  />
                                                <!-- ng-model="pinj_pokok" -->
                                              </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="inputBunga" name="input_bunga" autocomplete="off" value='{{($daf->pinj_prsbunga)/12}}' />
                                                    <span class="input-group-addon">% / bulan</span>
                                                </div>
                                            </div>
                                        </div>
        ...
        <!--Panel Tabel Pembayaran -->
                            ...
                            <div id="tabelPembayaran">
                                <table class="table-bordered"  style="border-style: solid 1px #000000;" width=100%  ame="histpaymenttable">
                                    <thead>
                                        <tr>
                                        <th style="background-color: #FF6347"><h4>JADWAL BARU KLIK SIMULASI DULU</h4></th>
                                        </tr>
                                        <tr></tr>
                                    </thead>
                                </table>
                            ...
                            <div class="col-sm-12">
                                 ...
                                 <table class="table-bordered"  style="border-style: solid 1px #000000;" name="histpaymenttable" width=100% >
                                    <thead>
                                        ...
                                        <tr><th colspan="8"><h4>-- JADWAL LAMA --</h4></th></tr>
                                        <tr>
...
//aset
    ...
    var asetlancar = ((kas+piutanglancar+inveslancar+asetlainlancar));
    var asettdklancar = ((piutangtidak+investidak+asetlaintidak));
    var aset = ((asetlancar+asettdklancar));
...
//lia
    ...
    var liapendek = ((utangpendek+pinjampendek+lialainpendek));
    var liapanjang = ((utangpanjang+pinjampanjang+lialainpanjang));
    var lia = ((liapendek+liapanjang));
...
//lainnya
    ...
    var bruto = ((pendapatan-beban));
    var pajak = ((bruto+pendapatanlain)-bebanlain);
    var ekui = ((aset-lia));
                ...
                content += '<div class="row"><div class="col-sm-12">';
                    ...
                    if(($('[name="input_jenis_angsuran"]').val() == "FLAT") || ($('[name="input_jenis_angsuran"]').val() == "BUNGA")){
                        content += '<hr /><table class="table table-striped" style="width:100%;">'+
                                      ...
                                      '<tr>'+
                                          '<th colspan="8" scope="colgroup"><h4 align="center">-- JADWAL BARU --</h5></th>'+
                                      '</tr>'+
                                      '<tr>'+
                        ...
                        for(var x = 0; x < $('[name="input_jangka_waktu"]').val(); x++){
                          ...
                          var saldopiutang = saldopokok+saldobbt;
                            ...
                            //tanggal arrear
                            if($('[name="input_jeniskredit"]').val() != "f"){ //arear
